...
$productsHp = $productClass->select_product_Hp();
?>
    ...
    <section class="product" id="">
      <div class="pro-center">
       ...
       <div class="main-product">
        ...
        if ($productsHp && $productsHp->num_rows > 0) {
            // Lặp qua từng sản phẩm và hiển thị
            while ($row = $productsHp->fetch_assoc()) {
            ...
            echo "<p>Không có sản phẩm nào thuộc danh mục Hp.</p>";
        }
        ?>
    </div>
</section>
