...
$productsLenovo = $productClass->select_product_Lenovo();
?>
...
<html lang="en">
  <head>
    ...
    <title>Lenovo</title>
    <!-- CSS-link -->
    <link rel="stylesheet" href="css/Lenovo.css" />
...
nwas FonqhPay5w/91JmVM2hMDcnK10nMGCdVK+iQrJ71zPJQd1w=="
    ...
    <style>
      .main-home {
        width: 100%;
        height: 50vh;
        background-image: url(img/lenovo20.jpg);
  ...
  <body>
    ...
    <section class="product" id="">
      <div class="pro-center">
       <h1>Best Products</h1>
       <p>The newest and highest quality laptop product
       </p>
      </div>
       <div class="main-product">
       <?php
            // Kiểm tra nếu có sản phẩm Acer
            if ($productsLenovo && $productsLenovo->num_rows > 0) {
                // Lặp qua từng sản phẩm và hiển thị
                while ($row = $productsLenovo->fetch_assoc()) {
                ...
                echo "<p>Không có sản phẩm nào thuộc danh mục Lenovo.</p>";
            }
            ?>
        </div>
    </section>
