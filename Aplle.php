<?php 
include "./html_backend/productClass.php"; // Bao gồm class productClass

// Khởi tạo đối tượng productClass
$productClass = new productClass();
?>
<?php
// Lấy danh sách sản phẩm Acer
$productsApple = $productClass->select_product_Apple();
?>
...
nwas FonqhPay5w/91JmVM2hMDcnK10nMGCdVK+iQrJ71zPJQd1w=="
    ...
    <style>
      .main-home {
        width: 100%;
        height: 50vh;
        background-image: url(img/Aplle.png);
    ...
    <section class="main-home">
     ...
     <section class="product">
        <div class="pro-center">
            ...
            <p>Sản phẩm laptop Apple mới nhất và chất lượng cao nhất</p>
        </div>

        <div class="main-product">
        <?php
            // Kiểm tra nếu có sản phẩm Acer
            if ($productsApple && $productsApple->num_rows > 0) {
                // Lặp qua từng sản phẩm và hiển thị
                while ($row = $productsApple->fetch_assoc()) {
                    ...
                    <div class="row">
                        ...
                        <div class="hovr-icon">
                            ...
                            <a href="/html_frontend/layout_user_html/layout/donhang.php">
                ...
                echo "<p>Không có sản phẩm nào thuộc danh mục Apple.</p>";
            }
            ?>
        </div>
    </section>
