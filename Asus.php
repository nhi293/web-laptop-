...
$productsAsus = $productClass->select_product_Asus();
?>
  ...
  <body>
    ...
    <section class="product" id="">
      <div class="pro-center">
       <h1>Best Products</h1>
       <p>The newest and highest quality laptop product</p>
      </div>
       <div class="main-product">
       
       <?php
            // Kiểm tra nếu có sản phẩm Acer
            if ($productsAsus && $productsAsus->num_rows > 0) {
                // Lặp qua từng sản phẩm và hiển thị
                while ($row = $productsAsus->fetch_assoc()) {
                ...
                echo "<p>Không có sản phẩm nào thuộc danh mục Asus.</p>";
            }
            ?>
        </div>
    </section>
